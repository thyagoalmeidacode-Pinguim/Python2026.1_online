...
## 7️⃣ Estudo de Caso: Sistema de Cadastro de Alunos

### Requisitos

* Solicitar: nome, idade, curso e email
* Salvar em arquivo `cadastro.txt`
* Organizar cada cadastro com uma linha separadora

### Código Sugerido com Conversão
...
# Exibindo cadastro usando f-string
print(f"Cadastro salvo: {nome}, {idade} anos, Curso: {curso}, Email: {email}")
```
...
* Conversão de tipos com `int()`, `float()` e `str()`
* Operadores matemáticos e lógicos
* Quatro formas de exibir valores
* Estudo de caso de cadastro de alunos
